...
class notepad:
    def __init__(self):
        # initialize
        self.file=None
        self.window=tkinter.Tk(className="Untitled - Pypad")
        ...
        self.editmenu.add_command(label="Bold/normal",command=self.italicfont,accelerator="Ctrl+i")
    ...
    def reset(self):
        ...
        self.file=None
        self.filename=None
        self.window.title("Untitled - PyPad") 
        self.flag=0
    ...
    def openfile(self,event=None):
        ...
        if(self.file==None or self.file==""):
            ...
            self.window.title(self.filename[0]+ " - PyPad")
            file.close()
    ...
    def saveas(self,event=None):
        ...
        self.window.title(filename[0]+" - PyPad")
        self.file=file.name
        file.close()
    ...
    def about(self):
        tkinter.messagebox.showinfo("PyPad","This notepad is created by Manibharathi using python") 
